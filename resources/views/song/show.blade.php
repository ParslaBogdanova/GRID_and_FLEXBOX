        ...
        <div class="flex justify-between">
            <div>
                ...
                <div class="px-6 pt-4 pb-2">
                    <span
                        class="inline-block shadow-lg bg-gray-400 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">{{ $song->artist }}</span>
                </div>
                <div class="px-6 pt-4 pb-2">
                    <span
                        class="inline-block shadow-lg bg-gray-400 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">{{ $song->genre }}</span>
                </div>
            </div>
            <div>
                    ...
                    @foreach ($song->playlists as $playlist)
                        <tr>
                            <td class="border px-4 py-2">
                                ...
                                <form action="{{ route('song.removePlaylist', $song->id) }}" method="POST"
                                    class="inline-block">
                                    @csrf
                                    @method('delete')
